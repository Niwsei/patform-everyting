...
import { ShieldCheck, MapPin, Coffee, Utensils, Building, ArrowLeft } from 'lucide-react';
          ...
          <div className="lg:col-span-8 space-y-12">
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
               <div className="p-8 bg-slate-50 rounded-[2.5rem] border border-slate-100">
                  ...
                  <h3 className="text-xl font-black text-slate-900 mb-4">คาเฟ่และไลฟ์สไตล์</h3>
               ...
               <div className="p-8 bg-slate-50 rounded-[2.5rem] border border-slate-100">
                  ...
                  <h3 className="text-xl font-black text-slate-900 mb-4">ความปลอดภัยระดับสูง</h3>
                  <p className="text-slate-500 font-bold leading-relaxed">
