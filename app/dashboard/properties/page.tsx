      ...
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          <div>
            ...
            <p className="text-slate-500 font-bold mt-2">Manage your listed rentals and track their performance.</p>
          </div>
          <Link
            href="/onboarding"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-slate-50">
                  <div>
                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-0.5">Monthly Rent</p>
          ...
          >
            ...
            <h3 className="font-black text-slate-900">List another nest</h3>
            <p className="text-slate-500 text-xs font-bold mt-2 uppercase tracking-widest">Expand your portfolio</p>
          </Link>
        </div>
      </div>
    </div>
